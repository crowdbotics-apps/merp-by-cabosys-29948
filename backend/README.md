...
## Project Structure
    ...
    ├── merp_by_cabosys_29948  # Django project configurations
...
1. Clone this repo and `cd merp_by_cabosys_29948`
...
2. Clone this repo and `cd merp_by_cabosys_29948`
